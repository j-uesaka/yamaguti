...
import { createMailResult } from "../graphql/mutations";
const client = generateClient();
export default function MailResultCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createMailResult.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "MailResultCreateForm")}
      {...rest}
    >
      <TextField
        label="From"
