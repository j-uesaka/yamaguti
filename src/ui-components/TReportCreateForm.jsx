...
import { createTReport } from "../graphql/mutations";
...
export default function TReportCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setReport_title(initialValues.report_title);
    setText(initialValues.text);
    setSubmission_approver_id(initialValues.submission_approver_id);
    setCurrentSubmission_approver_idValue("");
    setSubmission_department_id(initialValues.submission_department_id);
    setPresenter_id(initialValues.presenter_id);
    setTReport_status(initialValues.tReport_status);
    setAttachment(initialValues.attachment);
    setCurrentAttachmentValue("");
    setHidden_flag(initialValues.hidden_flag);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createTReport.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "TReportCreateForm")}
      {...rest}
    >
      <TextField
        label="Date"
