...
import { createMail } from "../graphql/mutations";
const client = generateClient();
export default function MailCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createMail.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "MailCreateForm")}
      {...rest}
    >
      <TextField
        label="Company"
