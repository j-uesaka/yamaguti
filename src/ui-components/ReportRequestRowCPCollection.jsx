...
import ReportRequestRowCP from "./ReportRequestRowCP";
...
export default function ReportRequestRowCPCollection(props) {
  ...
  return (
    <div>
      <Collection
        ...
        {...getOverrideProps(overrides, "ReportRequestRowCPCollection")}
        {...rest}
      >
        {(item, index) => {
          if (loading) {
